                ...
                <div class="flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="w-full md:w-1/4 pl-4">
                        ...
                        <p class="leading-relaxed text-base">
                            ...
                            <strong>entreprise: </strong>{{ $listing->company }}
                        </p>
    
                        @if(\Auth::check() && \Auth::user()->role === "Student")
                        <a href="{{ url('apply_offer/'.$listing->id) }}" class="block text-center my-4 tracking-wide bg-white text-indigo-500 text-sm font-medium title-font py-2 border border-indigo-500 hover:bg-indigo-500 hover:text-white uppercase">Postuler </a>
                      @endif
