<section class="text-gray-600 body-font border-b border-gray-100">
    <div class="container mx-auto flex flex-col px-5 pt-16 pb-8 justify-center items-center">
        <div class="w-full md:w-2/3 flex flex-col items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Bienvenue sur JobsFinder</h1>
            <p class="mb-8 leading-relaxed">Que vous souhaitiez changer de poste ou simplement voir ce qui est disponible, nous avons rassemblé cette liste complète de postes à pourvoir au sein d'une grande variété d'entreprises et de lieux de travail.</p>
            ...
            <p class="text-sm mt-2 text-gray-500 mb-8 w-full">INFO CESI</p>
        </div>
    </div>
</section>
